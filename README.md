...
To install Password Manager, download the "Installer.tar.gz" file onto your computer and execute the file.
[Installer.tar.gz](https://github.com/GabeCoder/password-manager/files/6207792/Installer.tar.gz)
